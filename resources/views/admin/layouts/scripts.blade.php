...
<!--   Optional JS   -->
<script src="{{ asset('master/assets/js/plugins/chart.js/dist/Chart.min.js') }}"></script>
<script src="{{ asset('master/assets/js/plugins/chart.js/dist/Chart.extension.js') }}"></script>
<!--   Argon JS   -->
